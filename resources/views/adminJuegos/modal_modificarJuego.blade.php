<!-- Modal -->
<div class="modal fade" id="modal_modificarJuego{{$game->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form method="post" action="">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="number" class="form-control" id="inputid4" name="id" placeholder="{{$game->id}}">
                  </div>
                </div>
