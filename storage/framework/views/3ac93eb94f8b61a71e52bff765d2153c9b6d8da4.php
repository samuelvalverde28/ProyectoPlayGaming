...
<div class="container">
  <ul class="nav nav-tabs justify-content-center">
    ...
    <li class="nav-item">
      <a class="nav-link active" href=" <?php echo e(route('jugando')); ?> ">Jugando</a>
    </li>
    <li class="nav-item">
                ...
                <?php $__currentLoopData = $Usersgame; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Usergame): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <?php if($Usergame->idusers == Auth::user()->id): ?>
                    ...
                    <?php $__currentLoopData = $Game; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Gamer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <?php if($Gamer->id == $Usergame->idgames && $Usergame->estado == 'jugando'): ?>
                        <div class="card">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PlayGaming\resources\views/cliente/jugando.blade.php ENDPATH**/ ?>